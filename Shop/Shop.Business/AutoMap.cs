    ...
    public class AutoMap : Profile
    {
        public AutoMap()
        {
            ...
            CreateMap<ProductDto, ResponseStuffModel>()
                ...
                .ForMember(dest => dest.LogoUrl, opt => opt.MapFrom(source => source.Logo))
                .ForMember(dest => dest.BackgroundUrl, opt => opt.MapFrom(source => source.Background))
            ...
            CreateMap<StuffModel,Product>()
                ...
                .ForMember(dest => dest.DateCreated, opt => opt.MapFrom(
                    (source, destination) =>
                        source.DateCreated != default ? source.DateCreated : destination.DateCreated))
                .ForMember(dest => dest.TotalRating, opt => opt.MapFrom(
                    (source, destination) =>
                        source.TotalRating.Equals(default) ? source.TotalRating : destination.TotalRating))
